...
1. `AG/P0-0 -> P0-1 -> P0-2 -> P0-3`  
2. `AG/P1-0 -> P1-1` 与 `AG/P1-2 -> P1-3` 并行推进，设同步点  
3. `AG/P2-0..3` 低耦合并行，按接口冻结先后落地
...
1. `sync-1`：`AG/P0-0` 完成后，A 才冻结 `AG/P2-3` 文档巡检规则。  
2. `sync-2`：`AG/P0-1` 完成后，B 才把 direct-write 规则写入治理规范。  
3. `sync-3`：`AG/P1-2` 完成后，A 的 CLI/core 重构 PR 才可合并。  
4. `sync-4`：`AG/P2-1` 完成后，A 再推进 `AG/P2-0` 目录迁移批次。
...
- W1：完成 `AG/P0-0..3`（阻塞问题清零）。  
- W2-W3：完成 `AG/P1-0..3`（结构与文档真相统一）。  
- W4：完成 `AG/P2-0..3`（维护性增强与自动巡检）。
