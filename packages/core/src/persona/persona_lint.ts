...
import { validateGenome, GENOME_FILENAME, EPIGENETICS_FILENAME, GENOME_TRAIT_NAMES } from "../state/genome.js";
import { VALUES_RULES_FILENAME } from "./values_rules.js";
import { PERSONALITY_PROFILE_FILENAME } from "./personality_profile.js";
import { GOALS_STATE_FILENAME } from "../state/goals_state.js";
import { BELIEFS_STATE_FILENAME } from "../state/beliefs_state.js";
