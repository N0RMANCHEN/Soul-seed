...
import { ensureRelationshipArtifacts } from "../state/relationship_state.js";
import { ensureCognitionStateArtifacts } from "./persona.js";
import { loadMoodState } from "../state/mood_state.js";
...
export async function loadPersonaPackageV04(rootPath: string): Promise<PackageLoadResult> {
  ...
  const { loadActiveEpisodes, getActiveEpisode } = await import("../state/emotion_episode_manager.js");
