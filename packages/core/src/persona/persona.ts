...
import { eventHash } from "../guards/hash.js";
import { ingestLifeEventMemory } from "../memory/memory_ingest.js";
import { ensureMemoryStore } from "../memory/memory_store.js";
import { createEmptySocialGraph, SOCIAL_GRAPH_FILENAME } from "./social_graph.js";
import { createEmptyTemporalLandmarks, TEMPORAL_LANDMARKS_FILENAME } from "../runtime/temporal_landmarks.js";
import {
  createInitialRelationshipState,
  ensureRelationshipArtifacts,
  writeRelationshipState
} from "../state/relationship_state.js";
import {
  createInitialMoodState,
  loadMoodState,
  MOOD_STATE_FILENAME
} from "../state/mood_state.js";
import {
...
import { createDefaultGoalsState, loadGoals } from "../state/goals_state.js";
import { createDefaultBeliefsState, loadBeliefs } from "../state/beliefs_state.js";
...
import {
  ...
  isVoiceLatentValid,
  isBeliefLatentValid
} from "../state/expression_belief_state.js";
import {
...
export async function patchCognitionState(
  ...
  const { shouldUseStateDeltaPipelineFromRoot, writeStateDelta } = await import("../state/state_delta_writer.js");
